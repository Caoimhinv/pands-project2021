...
I5 = ("\nISNULL() - this returns if there are any null or missing values. Everything here is FALSE which means no null values" + str(iris.isnull()) + "\n\n----------\n")
...
I9 = ("\nVALUE_COUNTS() - this shows how many values for each species\n" + str(iris["species"].value_counts()) + "\n\n----------\n")
...
I11 = ("\nDESCRIBE() by species - same overview but with each species isolated\n")
...
iris2 = iris.copy()
cols = iris2.columns
original_columns = iris2[cols[0:5]]
...
I20 = ("mean for versicolor " + str(versicolor[["totals"]].mean()) + "\n")
I21 = ("mean for virginica " + str(virginica[["totals"]].mean()) + "\n----------\n")

I22 = ("standard deviation for setosa " + str(setosa[['totals']].std()) + "\n")
I23 = ("standard deviation for versicolor " + str(versicolor[['totals']].std()) + "\n")
I24 = ("standard deviation for virginica " + str(virginica[['totals']].std()) + "\n")
