...
axs[0,0].legend(fontsize=6, loc='upper left', scatterpoints=3)
...
axs[0,1].legend(fontsize=6, loc='upper left', scatterpoints=3)
...
axs[0,2].legend(fontsize=6, loc='upper left', scatterpoints=3)
...
axs[2,0].legend(fontsize=6, loc='lower right', scatterpoints=3)
...
axs[2,2].legend(fontsize=6, loc='upper right', scatterpoints=3)
...
axs[3,0].legend(fontsize=6, loc='lower right', scatterpoints=3)
...
axs[3,2].legend(fontsize=6, loc='upper right', scatterpoints=3)
...
# set main title
plt.suptitle('Comparisons for each pair of variables', fontsize=15, fontname='fantasy')
plt.show()
